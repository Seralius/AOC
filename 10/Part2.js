...
function Run() {
    ...
    input.forEach(function (line) {
        ...
        if (first) {
            var Score = 0;
            var BuiltString = BuildString(line);
            if (BuiltString.length > line.length) {
                var Diff = BuiltString.slice(line.length, BuiltString.length)
    ...
    console.log(Sums[parseInt(Sums.length / 2)])
